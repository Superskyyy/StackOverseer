...
class Extractor:
    ...
    def __init__(self, api_key: str, request_type: str, site: str, question_id="", user_id="", **params):
        """
    ...
    def url_builder(self):
        ...
        if self.request_type == "search":
            ...
            if self.question_id != "":
                ...
                print("error")
        elif self.request_type == "user":
            self.request_url += self.api_root + "users/" + str(self.user_id) + "?" + urlencode(self.request_params)
            pass
...
if __name__ == "__main__":
    ...
    my_extractor = Extractor(api_key=API_KEY, request_type="search", site="stackoverflow",
    ...
    json_data = my_extractor.extract()
    print(json_data)
    answer_extractor = Extractor(api_key=API_KEY, request_type="question_answers",
                                 site="stackoverflow",
